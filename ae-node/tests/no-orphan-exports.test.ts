...
const KNOWN_ORPHANS: Record<string, string> = {
  ...
  signProductRegister: 'client-side (ae-app) + test signing of a tagging operation',
  signSpaceRegister: 'client-side (ae-app) + test signing of a tagging operation',
  signSupportiveSubmit: 'client-side (ae-app) + test signing of a tagging operation',
  signAmbientSubmit: 'client-side (ae-app) + test signing of a tagging operation',
  pendingTaggingOperationCount: 'test/observability helper for the tagging-op queue',
